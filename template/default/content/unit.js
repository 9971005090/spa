...
<tr>
    <td colspan="{{colspan}}" style="height: 100px; vertical-align: middle; text-align: center; border-bottom: 1px solid #d9dee3;">데이타 조회 중입니다.</td>
</tr>                           
`;
export const notFound = `
<tr>
    <td colspan="{{colspan}}" style="height: 100px; vertical-align: middle; text-align: center; border-bottom: 1px solid #d9dee3;">조회된 데이타가 없습니다.</td>
</tr>
`;
export const fail = `
<tr>
