    ...
    <section class="cm-header-section type02">
        <div class="cm-header-name">
            ...
            <h1 class="cm-header-logo">
                <a class="cm-header-logo-link" style="cursor: pointer">
                    ...
                    <span class="logo-txt">Brain Saver</span>
                </a>
            </h1>
        </div>
        <nav class="cm-top-menu">
            ...
            <ul class="cm-top-menu-ul">
                <li class="menu-list" data-info='{"datas": ["hospital", "fire-station"]}' data-location="/hospital/index">기관관리</li>
                <li class="menu-list" data-info='{"datas": ["medical-staff", "paramedic", "manager", "administrator"]}' data-location="/medical-staff/index">사용자관리</li>
                <li class="menu-list" data-info='{"datas": ["patient"]}' data-location="/patient/index">환자관리</li>
                <li class="menu-list" data-info='{"datas": ["push"]}' data-location="/push/index">푸시관리</li>
            </ul>        
        </nav>
