...
export const CONST = {
    ...
    EVENT : {
        ...
        SET_LEFT_MENU: function() {
            CUSTOM.EVENT.HTML.push(`main menu ul li`);
            $(`main menu ul li`).off("click").click(function(e) {
                etc.stopBubbling(e);
                let location = $(this).attr("data-location");
                let callback = $(this).attr("data-callback");
                if(location !== undefined && location !== "") {
        ...
        SET_BURGER: function() {
            CUSTOM.EVENT.HTML.push("#burger-button");
    ...
    POST_PROCESS: {
        index: async function(param = null) {
            ...
            // 좌측 메뉴 세팅
            CONST.POST_PROCESS.setLeftMenu(`main ul`, `main ul li`, CONST.EVENT.SET_LEFT_MENU, true);
        ...
        setPageTitle: function() {
            ...
            $(`main menu ul li`).each(function(index, item) {
        ...
        getLeftMenuInfo: function() {
            ...
            return {
                'design': {
                    'menuDataTable': `
                            {{#each datas}}
                            <li class="{{selected}}" data-info="{{data.info}}" data-location="{{data.location}}">
