...
GBL.DESIGN.SITE_META.TITLE = "BRAIN SAVER";
...
GBL.API.SET_BASE_URL = function() {
    if((location.hostname.indexOf('localhost') !== -1 || location.hostname.indexOf("127.0.0.1") !== -1 || location.hostname.indexOf('staging-') !== -1 || location.hostname.indexOf('seersipm') !== -1) === false) {
        ...
        GBL.API.BASE_URL = "https://api.brainsaver.co.kr/mobiCAREConsole/API";   // release
        GBL.DEBUG.USE = false;
        ...
        GBL.API.BASE_URL = "https://api.brainsaver.co.kr/mobiCAREConsole/API";   // test
        GBL.DEBUG.USE = true;
